...
def main():
	...
	model = compose.Pipeline(
      ...
      ('tree', RandomForestClassifier(n_trees=50,seed=42,patience=10,confidence=1e-2,criterion='entropy',max_depth=100,min_child_samples=1))
      )
	...
	print(model_selection.progressive_val_score(X_y=X_y, model=model, metric=metric,print_every=1000))	
